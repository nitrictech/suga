...
- **Provides access** - Read, write, delete operations
...
<Card title="Local Development" icon="laptop" href="/foundations/local-development" horizontal>
  Learn how to develop applications locally with Suga
</Card>
