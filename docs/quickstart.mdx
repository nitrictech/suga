...
<Note>
  **Prerequisites:** This guide assumes you have the Suga CLI installed. If you need to install it, see our [Installation Guide](/cli/installation) for platform-specific instructions.
</Note>
