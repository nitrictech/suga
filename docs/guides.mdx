...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="cloud"
    href="/guides/terraform-backend-config"
  >
...
1. **Suga CLI installed** - See our [Installation Guide](/installation)
...
- **Documentation** - Browse the complete [CLI Reference](/cli) for detailed command information
- **Support** - Contact us at [support@addsuga.com](mailto:support@addsuga.com)
