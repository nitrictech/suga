...
<Steps>
  ...
  <Step title="Create Backend Configuration">
    ...
    ```bash
    touch cdktf.out/stacks/<stack_name>/backend.tf
    ```
  </Step>

  <Step title="Add Backend Configuration">
    Add your configuration.
    See terraform docs on [backend configuration](https://www.terraform.io/docs/language/settings/backends/configuration.html)
  </Step>
