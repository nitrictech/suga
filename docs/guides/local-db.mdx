...
Nitric doesn’t auto-provision databases locally, giving you full choice and control. Here’s how to set up PostgreSQL for local use and any provider (Neon, Supabase, RDS) for production.
