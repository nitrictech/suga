...
<AccordionGroup>
  <Accordion title="Step 1: Setup PostgreSQL with Docker" icon="docker">
  ...
  <Accordion title="Step 2: Configure Database in Suga" icon="plug">
  ...
  <Accordion title="Step 3: Initialize Database Schema" icon="table">
    Create an `init.sql` file with your schema and test data:
    ...
    Start the database and apply your schema:
  ...
  <Accordion title="Step 4: Test Your Database Connection" icon="code">
