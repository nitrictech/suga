...
Suga itself is free during early access. You pay only your cloud provider's standard rates for resources (Lambda, S3, CloudFront, etc.).
...
Use your language's standard debugger with `suga dev`. See the [Local Development](/foundations/local-development) guide.
...
Suga is currently in early access. Pricing for future releases and enterprise features will be announced.

You only pay your cloud provider for infrastructure resources.

### Do I need a Suga account?

Yes, currently a Suga account is required. Sign up at [addsuga.com](https://addsuga.com).
