...
2. **Service restarts** - Suga restarts the affected service
...
- Use for configuration, API keys, feature flags
...
- **Cold starts** - Lambda cold starts don't occur locally
- **Latency** - No network latency between services
- **Resource limits** - Local resources not limited like Lambda (memory, timeout)
