...
class Bucket(
    ...
    fun read(key: String): ByteArray {
        ...
        val request = StorageReadRequest.newBuilder()
            .setBucketName(name)
            .setKey(key)
            .build()
        ...
        return try {
            ...
            throw RuntimeException("Failed to read file '$key' from bucket '$name': ${e.status.description}", e)
        } catch (e: Exception) {
    ...
    fun write(key: String, data: ByteArray) {
        ...
        val request = StorageWriteRequest.newBuilder()
            .setBucketName(name)
            .setKey(key)
        ...
        try {
            ...
            throw RuntimeException("Failed to write file '$key' to bucket '$name': ${e.status.description}", e)
        } catch (e: Exception) {
    ...
    fun delete(key: String) {
        ...
        val request = StorageDeleteRequest.newBuilder()
            .setBucketName(name)
            .setKey(key)
            .build()
        ...
        try {
            ...
            throw RuntimeException("Failed to delete file '$key' from bucket '$name': ${e.status.description}", e)
        } catch (e: Exception) {
    ...
    fun list(prefix: String? = null): List<String> {
        ...
        val request = StorageListBlobsRequest.newBuilder()
            .setBucketName(name)
        ...
        return try {
            ...
            throw RuntimeException("Failed to list files in bucket '$name' with prefix '$safePrefix': ${e.status.description}", e)
        } catch (e: Exception) {
    ...
    fun exists(key: String): Boolean {
        ...
        val request = StorageExistsRequest.newBuilder()
            .setBucketName(name)
            .setKey(key)
            .build()
        ...
        return try {
            ...
            throw RuntimeException("Failed to check if file '$key' exists in bucket '$name': ${e.status.description}", e)
        } catch (e: Exception) {
     ...
     */
    data class PresignUrlOptions(
        val mode: Mode,
        val expiry: java.time.Duration
    ) {
        init {
        ...
        companion object {
            ...
            @JvmStatic
            fun read(expiry: java.time.Duration): PresignUrlOptions = 
                PresignUrlOptions(Mode.READ, expiry)
    ...
    private fun preSignUrl(key: String, options: PresignUrlOptions): String {
        ...
        val operation = if (options.mode == Mode.WRITE) {
            StoragePreSignUrlRequest.Operation.WRITE
        } else {
            StoragePreSignUrlRequest.Operation.READ
        }

        val protobufDuration = Duration.newBuilder()
            .setSeconds(options.expiry.seconds)
            .setNanos(options.expiry.nano)
            .build()

        val request = StoragePreSignUrlRequest.newBuilder()
            .setBucketName(name)
            .setKey(key)
        ...
        return try {
            ...
            throw RuntimeException("Failed to get presigned URL for file '$key' in bucket '$name': ${e.status.description}", e)
        } catch (e: Exception) {
