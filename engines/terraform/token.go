...
var tokenPattern = regexp.MustCompile(`((?:infra|var|self|suga|service)\.[a-zA-Z_\-][a-zA-Z0-9_\-\.]*)`)
var allTokensPattern = regexp.MustCompile(`((?:infra|var|self|suga|service)\.[a-zA-Z_\-][a-zA-Z0-9_\-\.]*)`)
